...
from .forms import (
    ProgramForm, CourseAddForm, CourseAllocationForm, CourseForm,
...
def course_add(request, pk):
    ...
    return render(request, 'course/course_add.html', {
        'title': "Add Course | Techlogic.com",
...
def add_course(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            form.save()
            return redirect('home')  # Redirect to a view displaying a list of courses
    else:
        form = CourseForm()
